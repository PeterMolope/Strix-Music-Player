...
let track_art = document.querySelector('.artwork');
let track_name = document.querySelector('.song-name');
let track_artist = document.querySelector('.song-artist');
...
const music_list = [
    {
        img : 'files/artwork/cava.jpg',
        name : 'The Breakup Song',
        artist : 'Greg Kahn Band',
        music : 'files/song.mp3'
    }
];
